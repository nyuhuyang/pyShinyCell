...
matplotlib_colors = list("Sequential" =c('viridis', 'plasma', 'inferno', 'magma', 'cividis',
                                         'Greys', 'Purples', 'Blues', 'Greens', 'Oranges', 'Reds',
                                         'YlOrBr', 'YlOrRd', 'OrRd', 'PuRd', 'RdPu', 'BuPu',
                                         'GnBu', 'PuBu', 'YlGnBu', 'PuBuGn', 'BuGn', 'YlGn'),
                         "Diverging" = c('PiYG', 'PRGn', 'BrBG', 'PuOr', 'RdGy', 'RdBu', 'RdYlBu',
                                         'RdYlGn', 'Spectral', 'coolwarm', 'bwr', 'seismic'),
                         "Cyclic" = c('twilight', 'twilight_shifted', 'hsv'),
                         "Qualitative" = c('Pastel1', 'Pastel2', 'Paired', 'Accent', 'Dark2',
                                           'Set1', 'Set2', 'Set3', 'tab10', 'tab20', 'tab20b',
                                           'tab20c'),
                         "Miscellaneous" = c('flag', 'prism', 'ocean', 'gist_earth', 'terrain',
