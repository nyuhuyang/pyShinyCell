    ...
    fluidRow(
        column(
            ...
            conditionalPanel(
                ...
                numericInput("sc1f1cutfc", "filter genes with | log2FC | >", value = "0.25"),
                numericInput("sc1f1cutpct", "filter genes with of cells expressing % >", min = 0,max = 100, value = 10),
...
tabPanel(
    ...
    fluidRow(
        column(
            ...
            actionButton("sc1f2tog5", "Toggle filteration setting"),
            conditionalPanel(
                condition = "input.sc1f2tog5 % 2 == 1",
                numericInput("sc1f2top", "Select top N DEGs (negative values means down-regulated genes):",
...
tabPanel(
    ...
    fluidRow(
        column(
            ...
            actionButton("sc1g1tog5", "Toggle filteration setting"),
            conditionalPanel(
